package com.zhiqiantong.generator;
...
public class ContentCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //生成路径
        gc.setOutputDir(System.getProperty("user.dir") + "/zhiqiantong-plus-generator/src/main/java");
        gc.setAuthor("zxg");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://192.168.101.65:3306/zqt_" + SERVICE_NAME
