package com.zhiqiantong.orders.api;
...
import com.zhiqiantong.orders.util.SecurityUtil;
...
public class OrderController {
    ...
    public void requestpay(String payNo,HttpServletResponse httpResponse) throws IOException {
        //如果payNo不存在则提示重新发起支付
        ZqtPayRecord payRecord = orderService.getPayRecordByPayno(payNo);
        if(payRecord == null){
        ...
        if("601002".equals(status)){
            ZhiQianTongPlusException.cast("订单已支付，请勿重复支付。");
        }
        //构造sdk的客户端对象
...
//        alipayRequest.setReturnUrl("http://192.168.137.1/api/orders/receivenotify");
