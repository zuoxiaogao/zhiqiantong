...
import com.zhiqiantong.base.execption.CommonError;
...
public class CoursePublishServiceImpl extends ServiceImpl<CoursePublishMapper, CoursePublish> implements CoursePublishService {
    ...
    public void commitAudit(Long companyId, Long courseId) {
        ...
        if("202003".equals(auditStatus)){
            ZhiQianTongPlusException.cast("当前为等待审核状态，审核完成可以再次提交。");
        }
        //本机构只允许提交本机构的课程
        if(!courseBase.getCompanyId().equals(companyId)){
            ZhiQianTongPlusException.cast("不允许提交其它机构的课程。");
        }

        //课程图片是否填写
        if(StringUtils.isEmpty(courseBase.getPic())){
            ZhiQianTongPlusException.cast("提交失败，请上传课程图片");
        }
        ...
        if(teachplanTree.size() == 0){
            ZhiQianTongPlusException.cast("提交失败，还没有添加课程计划");
        }
        //转json
    ...
    public void publish(Long companyId, Long courseId) {
        ...
        if(coursePublishPre == null){
            ZhiQianTongPlusException.cast("请先提交课程审核，审核通过才可以发布");
        }
        //本机构只允许提交本机构的课程
        ...
        if(!"202004".equals(auditStatus)){
            ZhiQianTongPlusException.cast("操作失败，课程审核通过方可发布。");
        }
...
//            System.out.println(content);
            ...
            ZhiQianTongPlusException.cast("课程静态化异常");
        }
    ...
    public void uploadCourseHtml(Long courseId, File file) {
        ...
        if(course==null){
            ZhiQianTongPlusException.cast("上传静态文件异常");
        }
    ...
    private void saveCoursePublish(Long courseId){
        ...
        CoursePublishPre coursePublishPre = coursePublishPreMapper.selectById(courseId);
        if(coursePublishPre == null){
            ZhiQianTongPlusException.cast("课程预发布数据为空");
        }
    ...
    private void saveCoursePublishMessage(Long courseId){
        ...
        if(mqMessage==null){
            ZhiQianTongPlusException.cast(CommonError.UNKOWN_ERROR);
        }
    }
