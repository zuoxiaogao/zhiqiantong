package com.zhiqiantong.content.service.jobhandler;

import com.xxl.job.core.context.XxlJobHelper;
import com.xxl.job.core.handler.annotation.XxlJob;
import com.zhiqiantong.base.execption.ZhiQianTongPlusException;
import com.zhiqiantong.content.feignclient.SearchServiceClient;
import com.zhiqiantong.content.mapper.CoursePublishMapper;
...
import com.zhiqiantong.messagesdk.service.MessageProcessAbstract;
...
public class CoursePublishTask extends MessageProcessAbstract {
    ...
    private Boolean saveCourseIndex(Long courseId) {
        ...
        if(!add){
            ZhiQianTongPlusException.cast("添加索引失败");
        }
        return add;
